package EDM.edm.main.items.tools.hoe;
...
public class ItemHoeMain extends Item{
	protected EnumToolMaterials theToolMaterial;
	
	public ItemHoeMain(int par1, EnumToolMaterials par2EnumToolRuby)
	{
         super(par1);
